...
for lst in antenaDict.values():
    ...
    for pair in allPairs:
        ...
        if not (antiNodeX1 >= len(lines) or antiNodeX1 < 0 or antiNodeY1 >= len(lines[0]) or antiNodeY1 < 0):
        ...
        if not (antiNodeX2 >= len(lines) or antiNodeX2 < 0 or antiNodeY2 >= len(lines[0]) or antiNodeY2 < 0):
